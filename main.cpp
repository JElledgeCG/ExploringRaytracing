...
int main() {
    ...
    // Lookfrom, lookat, up vector, vFOV, aspect ratio, aperture, focus distance
    ...
    for (int j = image_height - 1; j >= 0; --j) {
        ...
        for (int i = 0; i < image_width; ++i) {
            ...
            for (int s = 0; s < samples_per_pixel; ++s) {
                auto u = (i + random_double() * blur_factor) / (image_width - 1);
                auto v = (j + random_double() * blur_factor) / (image_height - 1);
